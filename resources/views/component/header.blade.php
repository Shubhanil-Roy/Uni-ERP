            ...
            <ul class="navbar-nav mr-auto mt-md-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark"
                       href="" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-email"></i>
                        <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                    </a>--}}
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Factory</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('addManufacture')}}">Add Factory </a></li>
                        <li><a href="{{route('allManufacture')}}">All Factories</a></li>
                    </ul>
                </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">Sales</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('sales')}}">Sales Chart</a></li>
                        <li><a href="{{route('salesform')}}">Sales Form</a></li>
                    </ul>
                </li>
