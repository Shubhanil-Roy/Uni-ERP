            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-outline-info">
                        ...
                        <div class="card-body">
                            <form action="{{route('UpdateProductsStore')}}" class="form-horizontal" method="post"
                                  enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-body">
                                    <hr class="m-t-0 m-b-40">
                                    <input type="hidden" class="form-control" name="id"
                                           id="identity" value="{{$viewProduct->id}}">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group green-border-focus">
                                                        <input type="text" class="form-control" name="identity"
                                                               id="identity" value="{{$viewProduct->identity}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group green-border-focus">
                                                        <input type="text" class="form-control"
                                                               name="name" id="name" value="{{$viewProduct->name}}"> </input>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group green-border-focus">
                                                        <input type="number" class="form-control" name="length" placeholder="In INCH"
                                                               id="length" value="{{$viewProduct->length}}"> </input>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group green-border-focus">
                                                        <input type="number"
                                                               value="{{$viewProduct->width}}" class="form-control" placeholder="In INCH" name="width" id="width">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group green-border-focus">
                                                        <input type="number" class="form-control" name="height"
                                                               placeholder="In INCH" id="height" value="{{$viewProduct->height}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group green-border-focus">
                                                        <input type="number"value="{{$viewProduct->price}}"  class="form-control" name="price" id="price">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group green-border-focus">
                                                    <input type="date" class="form-control" name="manufacturing_date"
                                                           id="manufacturing_date" value="{{$viewProduct->manufacturing_date}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group green-border-focus">
                                                    ...
                                                    <select name="manufacturing_place_id" id="manufacturing_place_id" class="form-control" required>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group green-border-focus">
                                                    {{--<input type="text" class="form-control" name="warranty_time"
                                                           id="warranty_time">--}}
                                                    <select name="warranty_time" id="warranty_time" class="form-control" required>
                                                        <option>Years</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="reset" class="btn btn-success">Back</button>
