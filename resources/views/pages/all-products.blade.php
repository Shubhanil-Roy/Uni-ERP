            ...
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                    @foreach($products as $product)
                                            ...
                                            <div class="pull-right">
                                                <div class="col-md-10">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <address>
                                                                <h5><b class="text-danger">Identity :<!--</b>--></h5>
                                                                <p><h5>Variety :</h5></p>
                                                                <h5>Dimensions :</h5>
                                                                <h5>Product Code  :</h5>
                                                            </address>
                                                        ...
                                                        <div class="col-md-7">
                                                            <address>
                                                                <h5> &nbsp;<b class="text-danger">{{$product->identity}}</b></h5>
                                                                <p><h5><b class="text-danger">{{$product->name}}</b></h5></p>
                                                                <h5>{{$product->length.' inch'}} X {{$product->width.' inch'}} X {{$product->height}}</h5>
                                                                <h5></h5>
                                                            </address>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <h5> &nbsp;<b class="text-primary"><img style="height: 100px; width: 100px" src="data:image/svg+xml;base64,{{$product->qr_code}}" alt="QR Code" /></b></h5>
                                            </div>
                                        </div>
                    ...
                    <div class="text-right">
                        ...
                        <button id="print" class="btn btn-default btn-danger" type="button"> <span><i class="fa fa-print"></i> Print</span> </button>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
